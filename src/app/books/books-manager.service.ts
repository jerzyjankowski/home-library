...
export class BooksManagerService {
  ...
  private createSampleBook1(): Book {
    return {
      id: '1', title: 'Testing Angular Applications',
      ...
      category: 'FE>Angular', tags: ['Angular', 'Protractor', 'Karma', 'Jasmine'],
      sourceType: 'ebook', source: 'Manning (offline)',
      ...
      starred: true, recommendation: 1, state: 'current'
    };
  }
  private createSampleBook2(): Book {
    return {
      id: '2', title: 'Angular in Action',
      ...
      category: 'FE>Angular', tags: ['Angular', 'TypeScript'],
      sourceType: 'ebook', source: 'Manning (offline)',
      ...
      starred: false, recommendation: 0, state: 'finished'
    };
  }
  private createSampleBook3(): Book {
    return {
      id: '3', title: 'Vue.js in Action',
      ...
      category: 'FE>VueJS', tags: ['Vue.js'],
      sourceType: 'paperback', source: 'Manning (offline)',
      ...
      starred: false, recommendation: 0, state: 'fresh'
    };
  }
  private createSampleBook4(): Book {
    return {
      id: '4', title: 'Angela Yu',
      coverUrl: null,
      publishedYear: '2020', authors: 'Erik Hanchett with Benjamin Listwon',
      category: 'FE>General', tags: ['HTML5', 'CSS3', 'JavaScript', 'Node', 'React', 'MongoDB'],
      sourceType: 'video', source: 'Udemy (online)',
      mainNote: '',
      starred: false, recommendation: -1, state: 'paused'
    };
  }
  constructor() { }
}
